...
if TEST_ENV == "redis":
    ...
    cache_spec.update(
        {"type": "redis", "client": redis_client, "client_kwargs": redis_client_kwargs}
    )
elif TEST_ENV == "in-memory":
    cache_spec.update({"type": "in-memory", "client": None, "client_kwargs": None})
...
c.SAMLAuthenticator.cache_spec = cache_spec
